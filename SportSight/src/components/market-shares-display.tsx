...
export function MarketSharesDisplay({
    ...
    const calculateWinnings = (option: 'A' | 'B') => {
        ...
        const userProportion = (userShares * BigInt(1000000)) / totalSharesForOption;
    ...
    const userSharesA = Math.floor(Number(formatEther(sharesBalance.optionAShares)));
    const userSharesB = Math.floor(Number(formatEther(sharesBalance.optionBShares)));
